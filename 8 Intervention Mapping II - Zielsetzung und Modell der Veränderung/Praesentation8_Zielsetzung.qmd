...
- Input zu IM Schritt 2 mit interaktivem Quiz anschließend
- Arbeitsblatt mit Feedback
...
1.  **Verhaltensziel:** Das Endergebnis.
...
- Das Programmziel (Gesundheitsziel und Lebensqualitätziel) wird schon in Schritt 1 (Bedarfsanalyse) festgelegt. 
...
- Jedes Veränderungsziel beginnt zwingend mit einem *Verb*, das die intendierte psychologische oder funktionale Aktion konkret (nicht schwammig) definiert. --> Beobachtbares Verhalten!
...
- Bei Umweltzielen die zuständigen Agent:innen benennen
- SMART!

# Anwendung in kleineren Gruppen

- Fast identisch, aber: 
  - Fokus auf interpersonelle Ebene
  - stärkerer Fokus auf die genauen Gesprächstechniken (z.B. Motivational Interviewing)
  - eher kurzfristiges Programmziel (z.B. Wiederherstellung der Motivation)
  - Statt großer Matrizen eher Determinanten $\rightarrow$ Methoden $\rightarrow$ Strategien
