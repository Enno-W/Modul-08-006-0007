...
![](2026-04-10%2012-34-42.jpg){width="333"}
...
**Ziel:** Präsentation Ihres Konzepts mit anschließender kollegialer Beratung (bzw. Diskussion mit Mitstudierenden).

::: notes
**Theoretischer Background für die Diskussion:** - **Akkulturation durch Sport (Gieß-Stüber):** Sport ist hier kein Assimilationsinstrument ("Ihr müsst jetzt deutsch werden"), sondern ein Raum für "Reflexive Interkulturalität". Die Teilnehmer bringen ihre Bewegungskultur mit, während der Sportverein als Brücke zur Gesellschaft dient. - **Frame-Switching (Lott, 2010):** Der Sportplatz muss als "Sicherer Frame" etabliert werden, in dem andere Regeln gelten als im stressigen Heim-Alltag [@lott, S. 11]. - **Hofstede-Dimensionen:** - *Machtdistanz:* Trainer:innen sollten klare Führung bieten, da "Laissez-faire" oft als Inkompetenz oder Desinteresse missverstanden wird. - *Kollektivismus:* Fokus auf Team-Erfolge statt Einzelkritik, um "Gesichtsverlust" zu vermeiden. - **Traumasensible Tipps:** - Vermeidung von Trillerpfeifen (Trigger für Sirenen/Beschuss). - Keine Spiele mit "Einkesseln" oder Verfolgung (löst Panik aus). - Rhythmische, repetitive Bewegungen (Laufen, Tanzen, Trommeln) wirken regulierend auf das Nervensystem. - **Gender:** - Frauenspezifische Angebote sind oft essenziell für die Teilnahme (Sichtschutz!). - Gieß-Stüber betont, dass Schamgrenzen ernst genommen werden müssen, um Vertrauen aufzubauen.
:::
